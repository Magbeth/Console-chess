...
public class Pawn extends Piece {
    ...
    public boolean isMoveLegal(Piece[][] pieces, int x, int y, int i, int j) {
        ...
        if (i - x == 2 && j - y == 0 && firstMove && pieces[i - 1][j] == null) {
            return true;
        }
        ...
        if (((i - x == 1 && pieces[x][y].getColor() == Board.Color.WHITE) || (i - x == -1 && pieces[x][y].getColor() == Board.Color.BLACK)) && j - y == 0) {
            return true;
        }
